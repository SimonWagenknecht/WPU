...
//----------------------------------------------------------------------------------------------------
const char c_Objektbez [16]         = {"               "};  // 15              = {"Realschule     "}; 
const char c_Objektnum [10]         = {"         "};        //  9              = {"LU1-Klass"};       
const char c_Strasse   [16]         = {"               "};  // 15              = {"A67 LU1 Klassen"}; 
const char c_Nummer    [10]         = {"         "};        //  9              = {"         "};       
const char c_Ort       [16]         = {"               "};  // 15              = {"Koesching      "}; 
...
const Anlage Projekte[] = {
	...
	{	
	 ...
	 //"??-R-????-?????"			//Kennzeichen an fester Position !!	
		...
		// Namen für Prozess Ein- und Ausgänge (Namensvereinbarung in "userdef.h")
		// Aus den Namen werden Steuercodes generiert
		TA1,			// Außenlufttemp							TA				// 				Eingang IN1		Pt1000 / ----- / -------	
		...
		BMPU1,		// Betriebsmeldung PU HK1			BM PU HK1	// Block  Eingang IN5		Pt1000 / 0-10V / Digital
		AE_UNI1,	// Externe Anforderung									// 				Eingang IN6		Pt1000 / 0-10V / Digital
		STWHK1,		// Sicherheitstemperaturw.    STW HK1		// 				Eingang IN7		Pt1000 / 0-10V / Digital
		DE_FREI,	// FREI 																	 				Eingang IN8		Pt1000 / 0-10V / Digital
		...
		AA_UNI1,	// Regelungsventil SWP 									// Analog-Ausgang  AA2
		
		DA_UNI1,	// Freigabe/Anforderung WPU	Heizung					// Digital-Ausgang DA1
		DA_UNI2,	// Freigabe Anforderung WPU TWW							// Digital-Ausgang DA2
		DA_UNI3,	// Umschaltventil Wärmepumpe				UV SWP	// Digital-Ausgang DA3
		PU1EA,		// Pumpe Heizkreis									PU HK1	// Digital-Ausgang DA4
...
const Anl38 R38_Beleg[] = {
	...
	{	
		...
		TP_FREI,		// 										  											// Pt1000 Eingang IN12
		TVS1,				// Vorlauf Heizkreis 1							 TVHK1		// Pt1000 Eingang IN13
		TRS1,				// Rücklauf Heizkreis 1							 TRHK1		// Pt1000 Eingang IN14
	},
...
const WpStandard  Wp_Standparam[] = {
 // Profil 0 (dummy)
 {
  ...
  0,	// int	intPa_T_Speicherladung_off; 		// Speicherladung deaktivieren: delat T in [K] *10
	...
	0,	//int		Ts;								// Tastzeit (>= 1 s)						[s] * 10                                                                             
	0,	//UINT	Tn;								// Nachstellzeit								[s] * 10                                                                             
	0,	//int		Kp;								// P-Verstärkung							[%/K] * 100                                                                            
	0,	//int		Kd;								// D-Verstärkung							[%/K] * 100                                                                            
	0,	//int		Kpk;							// P-Verstärkung Kaskade			[%/K] * 100                                                                            
  ...
  // Profil 1 Solewärmepumpe
 {
  ...
  // Warmwasservorrang
	...
	0,	//UINT	Y_rel_min;				// Minimale Stellausgabe an 0-10V Ventil	[%] * 10
	1000,//UINT	Y_rel_max;				// Minimale Stellausgabe an 0-10V Ventil	[%] * 10                                                                   
	0,	//UINT	Y_rel_beg;				// Öffnungsbeginn des 0-10V Ventils				[%] * 10                                                                   	                                                                                                                                             
	// Wind-Up: Begrenzung der Stellgröße des PID-Reglers auf einen gleitenden oder festen Maximalwert (anti windup)                             
	0,	//int		Wup;									// 0 = gleitend (Produkt aus Kp * ei),  >0 = fester +/- Maximalwert  [%] * 10. ( nur positiven Wert eingeben  ) 
