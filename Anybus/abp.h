...
typedef enum ABP_MsgCmdType
{
   ...
   ABP_CMD_RESET_REQUEST       = 0x10    /* Reset-Request                     */
}
ABP_MsgCmdType;
...
#define ABP_OBJ_NUM_BAC             239   /* Bacnet Host Object               */
...
#define ABP_NC_INST_NUM_IPADRESSE					0x06
#define ABP_NC_INST_NUM_SUBNETMASK				0x07
#define ABP_NC_INST_NUM_GATEWAY						0x08
/*******************************************************************************
** Modbus - Network Instance
********************************************************************************
*/
#define ABP_NC_INST_NUM_MODBUS_IPADRESSE					0x03
#define ABP_NC_INST_NUM_MODBUS_SUBNETMASK					0x04
#define ABP_NC_INST_NUM_MODBUS_GATEWAY						0x05
...
#define ABP_APPD_CMD_GET_NEXT_GUARDED     0x11
...
/*******************************************************************************
**
** Bacnet Host object constants.
**
********************************************************************************
*/
/*------------------------------------------------------------------------------
**
** The Bacnet Host object instance attributes.
**
**------------------------------------------------------------------------------
*/
#define ABP_APPD_IA_BACNET_ONAME			1
#define ABP_APPD_IA_BACNET_VNAME			2
#define ABP_APPD_IA_BACNET_VID				3
#define ABP_APPD_IA_BACNET_MNAME			4
#define ABP_APPD_IA_BACNET_FW					5
#define ABP_APPD_IA_BACNET_APP_VERSION	6
#define ABP_APPD_IA_BACNET_ADVANCED			7
#define ABP_APPD_IA_BACNET_DATE_TIME		8
#define ABP_APPD_IA_BACNET_PASSWD				9
/*------------------------------------------------------------------------------
**
** The Bacnet Host object instance attribute descriptor bits.
**
**------------------------------------------------------------------------------
*/
...
/*------------------------------------------------------------------------------
**
** The Bacnet Host object specific message commands.
**
**------------------------------------------------------------------------------
*/

#define ABP_BACNET_CMD_GET_ADI_BY_BACNET_OBJECT    			0x10
#define ABP_BACNET_CMD_GET_ADI_BY_BACNET_NAME      			0x11
#define ABP_BACNET_CMD_GET_ALL_BACNET_OBJECT_INSTANCES  0x12
#define ABP_BACNET_CMD_GET_BACNET_OBJECT_BY_ADI		      0x13

/*------------------------------------------------------------------------------
**
** The Bacnet Host DataTyps.
**
**------------------------------------------------------------------------------
*/
#define	BACNET_ANALOG		2
#define	BACNET_BINARY		5
#define	BACNET_MULTI		19
#define BACNET_STRING		40
#define BACNET_PROPRIETARY	128
/*******************************************************************************
**
** Typedefs
**
