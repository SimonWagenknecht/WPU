...
//-------------------
	...
	{"*->;"," ZEITABSENKPHASE","       ", P&abs_ram[HK2].absen,	 JANEIN_FORM, 0, P&hid1,V1, 0, 0},
...
//#####ulsch : Ferienautomatik #####
	...
	#if ( BEDRAUM_HK2==1 || TRAUMK_HK2==1 )
	{" 53;"," KASKADE-MODUS  ","       ", P&hks[HK2].KaskMode,		 	 US_CHAR, 0, P&hid1,V1, 0, 0},
	#endif

	#if LEIBEGR_HK2 == 1
	{" 55;"," Xp LEIST.-BEGR."," K/%   ", P&hks[HK2].XpLeistBegr,		US_INT, 2, P&hid1,	V1, 0, 0},
	#endif

	#if BEDRAUM_HK2	== 1
	{" 56;"," VL MAX SOMMER  "," C    ", P&hks[HK2].VorlaufMaxSommer, US_INT, 1, P&hid1,	V1, 0, 0},
	#else
	{" ->;"," vl max sommer  "," C    ", P&hks[HK2].VorlaufMaxSommer, US_INT, 1, P&hid2,	V0, 0, 0},
	#endif	

// Freitags-Ventilöffnung
	#if ( BEDRAUM_HK2 == 1	&& FBH_HK2 == 0 )
	{" 57;"," HZG-ABSENK-TAGE"," Mo=1..", P&hks[HK2].VentiloeffngTag,	GWOTAG2_FORM, 0, P&hid1,	V1, 0, 0},
	{" 57;"," ABSENKBEGINN   "," h:min ", P&hks[HK2].VentiloeffngBeg,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 57;"," ABSENKENDE     "," h:min ", P&hks[HK2].VentiloeffngEnd,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 58;"," ABSENKWERT     "," K     ", P&hks[HK2].VentiloeffngAbs,		 		US_INT, 1, P&hid1,	V1, 0, 0},
	{" 59;"," ABSCHALT-TaGRNZ"," C    ", P&hks[HK2].GrenztempAbschalten,		 S_INT, 1, P&hid1,	V1, 0, 0},
	{"*->;"," absenken vo ?  ","       ", P&hkd[HK2].ventiloeffng,		 JANEIN_FORM, 0, P&hid2,	V1, 0, 0},
	#endif

// Schwerin: wenn Druck Rücklauf sekundär (0..10 V) aufgeschaltet ist
//	{" 58:"," HZG AUS SM DRU."," JA=1  ", P&hks[HK2].HzgAusSMDruck,		US_CHAR, 0, P&vis,	V1, 0, 0},
...
#if ( PU_BUS_HK2 == 0 || PULZ_HK2 == 1 )		// also auch wenn Schalten der Pumpe über Ausgang und Bus vorgesehen
	...
	{"*74:"," BM HEIZ-PU EIN?","       ", P&BMPU[HK2], 			 JANEIN_FORMIP, 0, P&vis,		V1, 0, 0},
	{" 74;"," WARTEN BM PUMPE"," min   ", P&hks[HK2].PuBmVerz,		 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->:"," puBmVerz Ctr   "," min/2 ", P&hkd[HK2].puBmVerz,		  US_INT, 0, P&hid2,	V0, 0, 0},
		#endif
	#endif

	#if PUDO_HK2 == 1
	{" 75:"," FUEHR.-PU.AKT. ","       ", P&hks[HK2].FuehrPu,			 US_CHAR, 0, P&vis,	  V1, 0, 0},	
	{" 75;"," FUEHR.-PU WECHS"," h     ", P&hks[HK2].PuWechseln,		US_INT, 0, P&hid1,	V1, 0, 0},	
	{" 75;"," FUEHR.-PU.FEST ","       ", P&hks[HK2].FuehrPuFest,	 US_CHAR, 0, P&hid1,	V1, 0, 0},
	#endif
#endif	

#if PU_BUS_HK2 > 0								// Bus-Pumpe
	{"*72:"," BUS-PUMPE EIN ?","       ", P&hkd[HK2].busPuEin, 			 JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{" 73;"," PU-SOLL NORMAL "," %     ", P&hks[HK2].BusPuSollwert,		 		US_INT, 1, P&hid1,	V1, 0, 0},
	{" 74;"," PU-SOLL ABSENK "," %     ", P&hks[HK2].BusPuSollwertAbsenk,	US_INT, 1, P&hid1,	V1, 0, 0},
#endif	

#if ( PULZ_HK2 == 1 || PU_BUS_HK2 > 0 )
	{" 76;"," PU-NACHLAUFZEIT"," min   ", P&hks[HK2].Puna,					US_CHAR, 0, P&hid1,	V1, 0, 0},
	...
	#if PUAL_HK2 == 1		// Störmeldung Pumpe vorhanden
		#if PUDO_HK2 == 1
	...
	#if PU_BUS_HK2 > 0
	{"*88:"," SM BUS PUMPE ? ","       ", P&hkd[HK2].busPuSm,	JANEIN_FORM, 0, P&vis,		A1, EINZEL,   0},
	#endif
	...
	{"*->;"," pid-stellgroess"," %     ", P&hkd[HK2].si_y_rel,			 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->;"," pid-windup     "," %     ", P&hks[HK2].Wup,			 			US_INT, 1, P&hid2,	V0, 0, 0},
	#endif

	//-------------------------------------------------------------------------------------------------
	{" 99;"," HAND/AUTOMATIK "," HAND=1", P&hks[HK2].Haut,				 US_CHAR, 0, P&hid1,	V1, 0, 0},

#if ( PU_BUS_HK2 == 0 || PULZ_HK2 == 1 )
	#if STRPU_HK2 == 0
		#if PUDO_HK2 == 1
