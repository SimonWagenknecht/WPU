...
//-------------------
	...
	#if TRAUMK_HK4==1 || (BEDARF_HK4==1 && BEDRAUM_HK4==1)
	...
	#if (BEDARF_HK4==1 && BEDRAUM_HK4==1) || TRAUMK_HK4==1
...
// Freitags-Ventilöffnung
	#if ( BEDRAUM_HK4 == 1	&& FBH_HK4 == 0 )
	{" 57;"," HZG-ABSENK-TAGE"," Mo=1..", P&hks[HK4].VentiloeffngTag,	GWOTAG2_FORM, 0, P&hid1,	V1, 0, 0},
	{" 57;"," ABSENKBEGINN   "," h:min ", P&hks[HK4].VentiloeffngBeg,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 57;"," ABSENKENDE     "," h:min ", P&hks[HK4].VentiloeffngEnd,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 58;"," ABSENKWERT     "," K     ", P&hks[HK4].VentiloeffngAbs,		 		US_INT, 1, P&hid1,	V1, 0, 0},
	{" 59;"," ABSCHALT-TaGRNZ"," C    ", P&hks[HK4].GrenztempAbschalten,		 S_INT, 1, P&hid1,	V1, 0, 0},
	{"*->;"," absenken vo ?  ","       ", P&hkd[HK4].ventiloeffng,		 JANEIN_FORM, 0, P&hid2,	V1, 0, 0},
	#endif

// Schwerin: wenn Druck Rücklauf sekundär (0..10 V) aufgeschaltet ist
//	{" 58:"," HZG AUS SM DRU."," JA=1  ", P&hks[HK4].HzgAusSMDruck,		US_CHAR, 0, P&vis,	V1, 0, 0},
	...
	#if SWAUS_HK4 == 1	// Anlagenschalter für HK-Nichtnutzung
...
#if ( PU_BUS_HK4 == 0 || PULZ_HK4 == 1 )		// also auch wenn Schalten der Pumpe über Ausgang und Bus vorgesehen
	#if STRPU_HK4 == 0			// keine Strahlpumpe
		#if PUDO_HK4 == 1			// Doppelpumpe
	...
	{"*73;"," PUMPEN-LAUFZEIT"," h     ", P&hkd[HK4].puLz,					US_INT, 0, P&hid1,	V1, 0, 0},
		...
		#if PUBM_HK4 == 1 // Betriebsmeldung Pumpe vorhanden
	...
	#if PUDO_HK4 == 1
	{" 75:"," FUEHR.-PU.AKT. ","       ", P&hks[HK4].FuehrPu,			 US_CHAR, 0, P&vis,	  V1, 0, 0},	
	{" 75;"," FUEHR.-PU WECHS"," h     ", P&hks[HK4].PuWechseln,		US_INT, 0, P&hid1,	V1, 0, 0},	
	{" 75;"," FUEHR.-PU.FEST ","       ", P&hks[HK4].FuehrPuFest,	 US_CHAR, 0, P&hid1,	V1, 0, 0},
	#endif
#endif	

#if PU_BUS_HK4 > 0								// Bus-Pumpe
	...
	#if PUAL_HK4 == 1		// Störmeldung Pumpe vorhanden
		#if PUDO_HK4 == 1
