...
// Freitags-Ventilöffnung
	...
	{" 57;"," HZG-ABSENK-TAGE"," Mo=1..", P&hks[HK3].VentiloeffngTag,	GWOTAG2_FORM, 0, P&hid1,	V1, 0, 0},
	{" 57;"," ABSENKBEGINN   "," h:min ", P&hks[HK3].VentiloeffngBeg,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 57;"," ABSENKENDE     "," h:min ", P&hks[HK3].VentiloeffngEnd,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 58;"," ABSENKWERT     "," K     ", P&hks[HK3].VentiloeffngAbs,		 		US_INT, 1, P&hid1,	V1, 0, 0},
	{" 59;"," ABSCHALT-TaGRNZ"," C    ", P&hks[HK3].GrenztempAbschalten,		 S_INT, 1, P&hid1,	V1, 0, 0},
	{"*->;"," absenken vo ?  ","       ", P&hkd[HK3].ventiloeffng,		 JANEIN_FORM, 0, P&hid2,	V1, 0, 0},
	#endif
